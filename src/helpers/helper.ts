...
/*Deprecated!!! Use: isMobileQuery() */ 
export function checkDevice(): { isMobile: boolean; isTablet: boolean; isPC: boolean } {
    ...
    const isTablet: boolean = /ipad|android|android 3.0|xoom|sch-i800|playbook|tablet|kindle/i.test(userAgent);
